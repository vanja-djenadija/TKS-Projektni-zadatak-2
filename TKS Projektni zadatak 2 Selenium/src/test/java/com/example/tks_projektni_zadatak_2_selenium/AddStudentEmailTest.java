...
public class AddStudentEmailTest {
    ...
    @Test
    public void studentEmailBeforeAdd() {
        ...
        assertThat(driver.findElement(By.xpath("/html/body/app-root/div/app-student-list/div[1]/div[2]/div/table/tbody/tr/td[2]")).getText(), is("vanja@gmail.com"));
    }
}